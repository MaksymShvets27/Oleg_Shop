 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ju=new lg("@firebase/auth");function eN(t,...e){Ju.logLevel<=he.WARN&&Ju.warn(`Auth (${Bi}): ${t}`,...e)}function hu(t,...e){Ju.logLevel<=he.ERROR&&Ju.error(`Auth (${Bi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di=new lg("@firebase/firestore");function g_(){return Di.logLevel}function B(t,...e){if(Di.logLevel<=he.DEBUG){const n=e.map(zg);Di.debug(`Firestore (${oo}): ${t}`,...n)}}function ar(t,...e){if(Di.logLevel<=he.ERROR){const n=e.map(zg);Di.error(`Firestore (${oo}): ${t}`,...n)}}function zs(t,...e){if(Di.logLevel<=he.WARN){const n=e.map(zg);Di.warn(`Firestore (${oo}): ${t}`,...n)}}function zg(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wV{constructor(){this.Qi=!1}initialize(e,n){this.Ki=e,this.indexManager=n,this.Qi=!0}getDocumentsMatchingQuery(e,n,r,i){return this.$i(e,n).next(s=>s||this.Ui(e,n,i,r)).next(s=>s||this.Wi(e,n))}$i(e,n){if(C_(n))return R.resolve(null);let r=lr(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Op(n,null,"F"),r=lr(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ie(...s);return this.Ki.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.Gi(n,a);return this.zi(n,u,o,l.readTime)?this.$i(e,Op(n,null,"F")):this.ji(e,u,n,l)}))})))}Ui(e,n,r,i){return C_(n)||i.isEqual(ee.min())?this.Wi(e,n):this.Ki.getDocuments(e,r).next(s=>{const o=this.Gi(n,s);return this.zi(n,o,r,i)?this.Wi(e,n):(g_()<=he.DEBUG&&B("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Dp(n)),this.ji(e,o,n,eM(i,-1)))})}Gi(e,n){let r=new Tt(Ix(e));return n.forEach((i,s)=>{Oh(e,s)&&(r=r.add(s))}),r}zi(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Wi(e,n){return g_()<=he.DEBUG&&B("QueryEngine","Using full collection scan to execute query:",Dp(n)),this.Ki.getDocumentsMatchingQuery(e,n,Zr.min())}ji(e,n,r,i){return this.Ki.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gy{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new F(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new F(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return fe(this._lat,e._lat)||fe(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Hj=()=>{const[t,e]=I.useState([]),n=an(un),r=[],i=mr(),[s,o]=I.useState(!1),[a,l]=I.useState();let u=new Date().getTime()/1e3;const c=p=>{l(p),o(!0)},h=()=>{o(!1)},d=async()=>{Gh(uo(Fe,"goods"),p=>{e(p.docs.map(v=>({...v.data(),id:v.id})).sort((v,_)=>v.createTime.seconds>_.createTime.seconds?-1:1))})};return I.useEffect(()=>{d()},[]),t.map(p=>{r.includes(p.category)||r.push(p.category)}),r.sort(),g.jsxs(g.Fragment,{children:[g.jsx(Fj,{children:r.map(p=>g.jsxs(zj,{children:[g.jsx(Uj,{children:p}),g.jsx(Bj,{children:t.map((v,_)=>{if(v.category===p)return g.jsxs(jy,{onClick:()=>c(v),style:{backgroundImage:`url(${v.image})`},children:[n.favoriteList&&n.favoriteList.map(w=>{if(w.name===v.name)return g.jsx(By,{})}),u-v.createTime.seconds<259200&&g.jsx(zy,{children:"Новинка!"}),g.jsxs(Fy,{children:[g.jsx(Uy,{children:v.name}),g.jsxs("p",{children:[v.price," грн."]})]})]},_)})}),g.jsx(Wj,{onClick:()=>i("/search",{state:{category:p}}),children:"Побачити більше"})]}))}),s&&g.jsx(Qh,{card:a,closeModal:h})]})},qj=A.div`
  display: flex;
  align-content: center;
  justify-content: center;
  flex-wrap: wrap;
...
`,FS=[{name:"Одяг",category:["Сукні","Сарафани","Спідниці","Нічний та домашній одяг","Термобілизна","Гірськолижний одяг","Шкарпетки","Панчохи","Колготки","Комбінезони та напівкомбінезони","Кофти","Светри","Кардигани","Костюми","Жакети","Спортивний одяг","Футболки","Майки","Шорти","Бриджі","Капрі","Джинси","Брюки","Легінси","Верхній одяг","Блузи","Сорочки","Для вагітних","Купальники","Пляжний одяг","Капрі","Штани","Піджаки","Гетри","Сліди","Спідня білизна","Пляжні шорти та плавки"]},{name:"Взуття",category:["Кросівки","Кеди","Снікери","Босоніжки","Сандалі","Туфлі","Балетки","Сліпони","Еспадрильї","Сабо","В'єтнамки","Шльопанці","Чоботи","Черевики","Уги","Ботильйони","Мокасини","Топсайдери","Лофери","Сандалі"]},{name:"Сумки та аксесуари",category:["Сумки","Рюкзаки","Валізи","Аксесуари для волосся","Годинники","Рукавички та рукавиці","Біжутерія","Головні убори","Ремені та пояси","Гаманці","Портмоне","Ремені","Пояси","Хустки","Шарфи","Краватки","Підтяжки","Прикраси","Парасолі","Сонцезахисні окуляри","Дорожні сумки"]},{name:"Товари для дому",category:["Пледи","Засоби для збирання","Господарські товари","Термоси та пляшки","Чашки","Кухлі","Рушники","Домашній текстиль","Аромати для дому"]},{name:"Іграшки для дітей"},{name:"Інструменти/обладнання"},{name:"Зоотовари"},{name:"Ювелірні вироби"},{name:"Велосипеди та аксесуари",category:["Велоаксесуари","Велокомп'ютери","Велошоломи","Велосумки","Велоодяг","Велоперчатки","Фляги та флягоутримувачі"]},{name:"Аксесуари для телефонів"},{name:"Спорт та захоплення",category:["Трекінгові палиці","Гірськолижні маски","Гірськолижні шоломи","Гірськолижні рукавички","Лижні палиці","Активний відпочинок","Bуризм та хобі","Газові та мультипаливні туристичні системи","Складні меблі","Посуд для відпочинку та туризму","Спальні мішки","Намети та аксесуари","Черевики для сноубордів","Кріплення для сноуборду","Черевики для лиж","Туристичні килимки","Зимові види спорту"]},{name:"Краса та здоров'я"},{name:"Електронні сигарети"},{name:"Кальяни та аксесуари"},{name:"Товари для бізнесу"}];let _i=(t=21)=>crypto.getRandomValues(new Uint8Array(t)).reduce((e,n)=>(n&=63,n<36?e+=n.toString(36):n<62?e+=(n-26).toString(36).toUpperCase():n>62?e+="-":e+="_",e),"");const Yj=()=>{const e=pr().state,n=an(un),[r,i]=I.useState([]),[s,o]=I.useState(r),[a,l]=I.useState(!1),[u,c]=I.useState(),[h,d]=I.useState(""),[p,v]=I.useState(e&&e.category?e.category:"");let _=new Date().getTime()/1e3;const w=y=>{c(y),l(!0)},m=()=>{l(!1)},f=()=>{Gh(uo(Fe,"goods"),y=>{i(y.docs.map(E=>({...E.data(),id:E.id})).sort((E,x)=>E.createTime.seconds>x.createTime.seconds?-1:1))})};return I.useEffect(()=>{f()},[]),I.useEffect(()=>{if(h.length>0){let y=r.filter(E=>E.name.toLocaleLowerCase().includes(h.toLocaleLowerCase())&&E.category.toLocaleLowerCase().includes(p.toLocaleLowerCase()));o(y)}else{let y=r.filter(E=>E.category.toLocaleLowerCase().includes(p.toLocaleLowerCase()));o(y)}},[h,p,r]),g.jsxs(qj,{children:[g.jsx(Gj,{placeholder:"Назва товару",onChange:y=>{d(y.target.value)}}),g.jsxs(Kj,{id:"category",name:"category",value:p,onChange:y=>{v(y.target.value)},children:[g.jsx(qn,{value:"",selected:!(e&&e.category)&&"selected"||null,children:"Без категорії"},_i()),FS.map((y,E)=>y.category?g.jsx("optgroup",{label:`${y.name}`,children:y.category&&y.category.map(x=>g.jsx(qn,{value:`${x}`,selected:p===x&&"selected"||null,children:x},_i()))},_i()):g.jsx(qn,{value:`${y.name}`,style:{fontWeight:"bolder"},selected:p===y.name&&"selected"||null,children:y.name},_i()))]}),g.jsx($y,{children:s.length>0?s.map((y,E)=>g.jsx(g.Fragment,{children:g.jsxs(jy,{onClick:()=>w(y),style:{backgroundImage:`url(${y.image})`},children:[n.favoriteList&&n.favoriteList.map(x=>{if(x.name===y.name)return g.jsx(By,{})}),_-y.createTime.seconds<259200&&g.jsx(zy,{children:"Новинка!"}),g.jsxs(Fy,{children:[g.jsx(Uy,{children:y.name}),g.jsxs("p",{children:[y.price," грн."]})]})]},E)})):g.jsxs(Qj,{children:[g.jsx("p",{children:"Нічого не знайдено"}),g.jsx("p",{children:" (використайте фільтр пошуку)"})]})}),a&&g.jsx(Qh,{card:u,closeModal:m})]})},Xj=()=>{const[t,e]=I.useState([]),n=()=>{Gh(uo(Fe,"orders"),o=>{e(o.docs.map(a=>({...a.data(),id:a.id})).sort((a,l)=>a.postDate.seconds>l.postDate.seconds?-1:1))})},r=async o=>{await IS(wt(Fe,"orders",`${o}`))},i=async o=>{await xi(wt(Fe,"orders",`${o}`),{status:"take"})},s=async o=>{await xi(wt(Fe,"orders",`${o}`),{status:"send"})};return I.useEffect(()=>{n()}),g.jsx(G$,{children:t.map(o=>g.jsxs(K$,{style:o.status==="take"?{backgroundColor:"yellow"}:o.status==="send"?{backgroundColor:"green"}:{},children:[g.jsxs("p",{children:["Статус: ",o.status==="create"&&"Нове"," ",o.status==="take"&&"Прийняте",o.status==="send"&&"Відправлене"]}),g.jsxs("p",{children:["Дата замовлення:"," ",new Intl.DateTimeFormat("en-US").format(o.postDate.seconds)]}),g.jsxs("p",{children:["ФІП: ",o.userFullName]}),g.jsxs("p",{children:["Email: ",o.userEmail]}),g.jsxs("p",{children:["Номер телефону:",o.userNumber]}),g.jsxs("p",{children:["Адрес Нової почти: ",o.userPostAdress]}),g.jsx("p",{children:"Список замовлення:"}),o.cashList.map(a=>g.jsxs(g.Fragment,{children:[g.jsx(Q$,{style:{backgroundImage:`url(${a.image})`}}),g.jsxs("p",{children:["Id товару: ",a.id]}),g.jsxs("p",{children:["Назва: ",a.name]}),g.jsxs("p",{children:["Ціна: ",a.price]})]})),g.jsxs(Y$,{children:[g.jsx(X$,{onClick:()=>r(o.id)}),g.jsx(J$,{onClick:()=>i(o.id)}),g.jsx(Z$,{onClick:()=>s(o.id)})]})]}))})},Jj=()=>{const{role:t}=an(un),e=mr(),r=pr().state,i=Ui(),[s,o]=I.useState(r?r.image:""),[a,l]=I.useState(r?r.name:""),[u,c]=I.useState(r?r.price:""),[h,d]=I.useState(r?r.producent:""),[p,v]=I.useState(r?r.size:""),[_,w]=I.useState(r?r.otherInfo:""),m=async f=>{try{r?(await Sy(wt(Fe,"goods",`${f.id}`),f),alert("Change success")):(await U4(uo(Fe,"goods"),f),alert("Add success"))}catch(y){console.error("Error adding document: ",y)}};return I.useEffect(()=>{document.getElementById("form").addEventListener("submit",function(y){y.preventDefault();const{image:E,name:x,price:C,sex:b,producent:P,category:q,size:V,otherInfo:z}=this.elements,ue={image:E.value,name:x.value,price:C.value,sex:b.value||"",producent:P.value||"",category:q.value,size:V.value||"",otherInfo:z.value||"",createTime:new Date};m(ue),this.reset()})},[i]),I.useEffect(()=>{t!="admin"&&e("/")}),g.jsxs(g.Fragment,{children:[g.jsxs($j,{id:"form",children:[g.jsx("p",{children:"Малюнок"}),g.jsx(xo,{required:!0,name:"image",placeholder:"Додати ссилку на картинку",value:s,onChange:f=>o(f.target.value)}),g.jsx("p",{children:"Назва"}),g.jsx(xo,{required:!0,name:"name",placeholder:"Додати назву",value:a,onChange:f=>l(f.target.value)}),g.jsx("p",{children:"Ціна в гривнях"}),g.jsx(xo,{required:!0,name:"price",placeholder:"Додати ціну",value:u,onChange:f=>c(f.target.value)}),g.jsx("p",{children:"Категорія"}),g.jsxs(Gp,{id:"category",name:"category",children:[g.jsx(qn,{value:"",children:"Вкажіть категорію"}),FS.map((f,y)=>f.category?g.jsx("optgroup",{label:`${f.name}`,children:f.category&&f.category.map(E=>g.jsx(qn,{value:`${E}`,selected:r&&r.category===E&&"selected"||null,children:E},_i()))},_i()):g.jsx(qn,{value:`${f.name}`,style:{fontWeight:"bolder"},selected:r&&r.category===f.name&&"selected"||null,children:f.name},_i()))]}),g.jsx("p",{children:"Рід"}),g.jsxs(Gp,{id:"sex",name:"sex",placeholder:"Вибрати рід",children:[g.jsx(qn,{value:"",children:"Без роду"}),g.jsx(qn,{value:"Чоловік",selected:r&&r.sex==="Чоловік"&&"selected"||null,children:"Чоловік"}),g.jsx(qn,{value:"Жінка",selected:r&&r.sex==="Жінка"&&"selected"||null,children:"Жінка"})]}),g.jsx("p",{children:"Розмір"}),g.jsx(xo,{name:"size",placeholder:"Додати розмір",value:p,onChange:f=>v(f.target.value)}),g.jsx("p",{children:"Виробник"}),g.jsx(xo,{name:"producent",placeholder:"Додати виробника",value:h,onChange:f=>d(f.target.value)}),g.jsx("p",{children:"Додаткова інформація"}),g.jsx(jj,{name:"otherInfo",placeholder:"Додати додаткову інформацію",value:_,onChange:f=>w(f.target.value)}),g.jsx(jS,{children:r?"Зілити зміни":"Залити новий товар"})]}),g.jsx("h3",{children:"Замовлення"}),g.jsx(Xj,{})]})},Zj=()=>{const[t,e]=I.useState([]),[n,r]=I.useState(!1),[i,s]=I.useState(),o=an(un),a=Ui();let l=new Date().getTime()/1e3;I.useEffect(()=>{Nr.getItem("userEmail")&&Nr.getItem("userPassword")&&u()},[]);const u=async()=>{const p=await Nr.getItem("userEmail"),v=await Nr.getItem("userPassword");a(Ly({email:p,password:v})),a(My(p))},c=p=>{s(p),r(!0)},h=()=>{r(!1)},d=()=>{Gh(uo(Fe,"goods"),p=>{e(p.docs.map(v=>({...v.data(),id:v.id})).sort((v,_)=>v.createTime.seconds>_.createTime.seconds?-1:1))})};return I.useEffect(()=>{d()},[]),g.jsxs(g.Fragment,{children:[g.jsx($y,{id:"cardList",children:t.length>0&&t.map((p,v)=>g.jsx(g.Fragment,{children:g.jsxs(jy,{onClick:()=>c(p),style:{backgroundImage:`url(${p.image})`},children:[o.favoriteList&&o.favoriteList.map(_=>{if(_.name===p.name)return g.jsx(By,{})}),l-p.createTime.seconds<259200&&g.jsx(zy,{children:"Новинка!"}),g.jsxs(Fy,{children:[g.jsx(Uy,{children:p.name}),g.jsxs("p",{children:[p.price," грн."]})]})]},p.id)}))}),n&&g.jsx(Qh,{card:i,closeModal:h})]})},eF=A.h2`
  font-size: 16px;
  @media (min-width: 768px) {
    font-size: 24px;
  }
...
`,cF=()=>{const{cashList:t}=an(un),e=Ui(),n=mr();return g.jsxs(tF,{children:[g.jsx(eF,{children:"Список товарів"}),t.length>0?g.jsxs(g.Fragment,{children:[t.map((r,i)=>g.jsxs(rF,{children:[g.jsx(nF,{style:{backgroundImage:`url(${r.image})`}}),g.jsxs(iF,{children:[g.jsx(sF,{children:r.name}),g.jsxs(oF,{children:[r.price," грн."]})]}),g.jsx(aF,{onClick:()=>e(wj(i)),children:g.jsx(lF,{})})]})),g.jsx(uF,{onClick:()=>n("/checkout"),children:"Перейти до оформлення відправки"})]}):"Корзина пуста"]})},hF=A.div`
  display: flex;
  gap: 5px;
  flex-direction: column;
  align-items: center;
...
`,pF=()=>{const t=an(un),[e,n]=I.useState(""),[r,i]=I.useState(""),[s,o]=I.useState(""),[a,l]=I.useState(""),[u,c]=I.useState(""),[h,d]=I.useState(""),[p,v]=I.useState(""),[_,w]=I.useState(""),[m,f]=I.useState(!1),y=Ui(),E=mr(),x=async()=>{const z=await Ty(wt(Fe,"users",`${t.email}`));if(z.exists()){const{name:ue,userPostAdress:Oe,userNumber:Ve,email:Se}=z.data();o(Se),n(ue),i(Ve),l(Oe)}else console.log("No such document!")};I.useEffect(()=>{t.email&&x()},[t]);const C=z=>{n(z.target.value),/^(\W+[^!@#$%^&*()_+~`/?\|=1234567890])\s+(\W+[^!@#$%^&*()_+~`/?\|=1234567890])\s+(\W+[^!@#$%^&*()_+~`/?\|=1234567890])$/.test(String(z.target.value).toLowerCase())?c(""):c("Введіть повнe призвіще, ім'я, побатькові")},b=z=>{o(z.target.value),/^[\w\-\.]+@([\w-]+\.)+[\w-]{2,}$/.test(String(z.target.value).toLowerCase())?d(""):d("Електронний адрес повинен містити літери латинського алфавіту, символи '@' та '.'")},P=z=>{i(z.target.value),/^([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])$/.test(String(z.target.value))?v(""):v("Номер невірного формату (наприклад: '043*******')")},q=z=>{l(z.target.value),z.target.value.length>0?w(""):w("Адрес відділення пошти пустий")},V=async()=>{if(s&&e&&r&&a&&!h&&!p&&!u&&!_)try{const z=new Date,ue=z.getFullYear()+"-"+(z.getMonth()+1)+"-"+z.getDate()+" "+z.getHours()+":"+z.getMinutes()+":"+z.getSeconds();await Sy(wt(Fe,"orders",`${ue}`),{userFullName:e,userNumber:r,userEmail:s,userPostAdress:a,postDate:ue,id:`${s}${ue}`,status:"create",cashList:t.cashList}),y(j$()),E("/")}catch(z){console.log(z)}else f(!0)};return I.useEffect(()=>{!h&&!p&&!u&&!_&&f(!1)}),g.jsxs(hF,{id:"CheckoutForm",children:[g.jsx(dF,{children:"Контактні дані"}),g.jsx(Xl,{required:!0,name:"name",value:e,onChange:z=>{C(z)},placeholder:"Введіть ПІБ",style:u?{borderColor:"red"}:{}}),u&&g.jsx(So,{children:u}),g.jsx(Xl,{value:r,onChange:z=>{P(z)},placeholder:"Введіть контактний номер телефону",style:p?{borderColor:"red"}:{}}),p&&g.jsx(So,{children:p}),g.jsx(Xl,{required:!0,name:"email",value:s,onChange:z=>{b(z)},placeholder:"Введіть контактну електронну адресу",style:h?{borderColor:"red"}:{}}),h&&g.jsx(So,{children:h}),g.jsx(Xl,{value:a,onChange:z=>{q(z)},placeholder:"Введіть адресу відділення пошти",style:_?{borderColor:"red"}:{}}),_&&g.jsx(So,{children:_}),g.jsx(So,{children:'Попередження, відправка куплених товарів відбувається виключно мережею відділень "Нова пошта", оплатою при отриманні !!!'}),g.jsx(yw,{children:"Для додаткової інформації чи відказу від замовлення"}),g.jsx(yw,{children:"сконтактуйтесь з адміністратором msshopua@gmail.com"}),g.jsx(fF,{onClick:V,style:m?{background:"red"}:{},children:m?"Невірно заповнена форма":"Завершити оформлення замовлення"})]})};function mF(){return g.jsxs(cR,{children:[g.jsxs(Bn,{path:"/",element:g.jsx(Vj,{}),children:[g.jsx(Bn,{index:!0,element:g.jsx(Zj,{})}),g.jsx(Bn,{path:"category",element:g.jsx(Hj,{})}),g.jsx(Bn,{path:"search",element:g.jsx(Yj,{})}),g.jsx(Bn,{path:"admin",element:g.jsx(Jj,{})}),g.jsx(Bn,{path:"cashList",element:g.jsx(cF,{})}),g.jsx(Bn,{path:"checkout",element:g.jsx(pF,{})})]}),g.jsx(Bn,{path:"*",element:g.jsx(aR,{to:"/"})})]})}var US="persist/FLUSH",Wy="persist/REHYDRATE",zS="persist/PAUSE",BS="persist/PERSIST",WS="persist/PURGE",Hy="persist/REGISTER";function vw(t){return vF(t)||yF(t)||gF()}function gF(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function yF(t){if(Symbol.iterator in Object(t)||Object.prototype.toString.call(t)==="[object Arguments]")return Array.from(t)}function vF(t){if(Array.isArray(t)){for(var e=0,n=new Array(t.length);e<t.length;e++)n[e]=t[e];return n}}function _w(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function Kp(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?_w(n,!0).forEach(function(r){_F(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):_w(n).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function _F(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var HS={registry:[],bootstrapped:!1},wF=function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:HS,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case Hy:return Kp({},e,{registry:[].concat(vw(e.registry),[n.key])});case Wy:var r=e.registry.indexOf(n.key),i=vw(e.registry);return i.splice(r,1),Kp({},e,{registry:i,bootstrapped:i.length===0});default:return e}};function EF(t,e,n){var r=n||!1,i=Oy(wF,HS,e&&e.enhancer?e.enhancer:void 0),s=function(u){i.dispatch({type:Hy,key:u})},o=function(u,c,h){var d={type:Wy,payload:c,err:h,key:u};t.dispatch(d),i.dispatch(d),r&&a.getState().bootstrapped&&(r(),r=!1)},a=Kp({},i,{purge:function(){var u=[];return t.dispatch({type:WS,result:function(h){u.push(h)}}),Promise.all(u)},flush:function(){var u=[];return t.dispatch({type:US,result:function(h){u.push(h)}}),Promise.all(u)},pause:function(){t.dispatch({type:zS})},persist:function(){t.dispatch({type:BS,register:s,rehydrate:o})}});return e&&e.manualPersist||a.persist(),a}const IF=RS({[Cc.name]:Cc.reducer}),qS=w$({reducer:IF,middleware:t=>t({serializableCheck:{ignoredActions:[US,Wy,zS,BS,WS,Hy]}})});EF(qS);lf.createRoot(document.getElementById("root")).render(g.jsx(Pt.StrictMode,{children:g.jsx(mR,{basename:"Oleg_Shop",children:g.jsx(pP,{store:qS,children:g.jsx(mF,{})})})}));
